...
func init() {
	...
	useCaseMatrix = map[string]map[string]utils.QueryFillerMaker{
		...
		"iot2": {
			iot2.LabelDailyFuelConsumptionRow: iot2.NewDailyFuelConsumptionRow,
			iot2.LabelDailyLowFuelCount:       iot2.NewAllInOrder,
			iot2.LabelDailyAverageLoad:        iot2.NewDailyAverageLoad,
			iot2.LabelAllInOrder:              iot2.NewAllInOrder,
		},
	}
